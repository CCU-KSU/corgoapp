    ...
    return (
        <>
            <div className="input">
                ...
                <input className="input-field" id={id} name={id} type={type} placeholder={placeholder} disabled={disabled} required={isRequired} onChange={handleInputChange} min={min} max={max} autoComplete={autoComplete} value={value} />
            </div>
        </>
    );
}
